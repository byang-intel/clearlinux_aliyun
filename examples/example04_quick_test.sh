...
[ -e clear.img ] || ( curl -o clear.img.xz https://download.clearlinux.org/image/clear-$(curl https://download.clearlinux.org/latest)-kvm.img.xz && unxz -v clear.img.xz )
[ -e OVMF.fd ] || curl -O https://download.clearlinux.org/image/OVMF.fd 
